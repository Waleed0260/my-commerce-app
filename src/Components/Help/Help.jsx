...
const Help = () => {
  ...
  return (
   ...
   <div className="first-block">
    <h4 onClick={()=> setClick(true)}> <span>How to contact with Customer Service?</span> <span><AiOutlinePlus/></span> </h4>
   ...
   <div className="first-block" style={{marginTop: "20px"}}>
    <h4 onClick={()=> setDone(true)}> <span>App installation failed, how to update system information?</span> <span><AiOutlinePlus/></span> </h4>
   ...
   <div className="first-block" style={{marginTop: "20px"}}>
    <h4 onClick={()=> setThird(true)}> <span>Website response taking time, how to improve?</span> <span><AiOutlinePlus/></span> </h4>
   ...
   <div className="first-block" style={{marginTop: "20px"}}>
    <h4 onClick={()=> setForth(true)}> <span>Website response taking time, how to improve?</span> <span><AiOutlinePlus/></span> </h4>
